        ...
        <div className=" text-white py-14 container mx-auto">
          ...
          <div className="social-login-buttons">
            <div className="flex flex-col  items-center gap-2 min-h-screen p-10">
              <button className="flex items-center cursor-pointer w-64 text-black bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-900 hover:bg-gray-200  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                <svg
